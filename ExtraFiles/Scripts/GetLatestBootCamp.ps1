...
$BootCampInstallers = @()
$Plist = ConvertFrom-Plist -plist $([xml](Get-Content 'C:\Users\asjimene\Downloads\index-10.14-10.13-10.12-10.11-10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1.sucatalog'))
